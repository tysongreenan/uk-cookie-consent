...
const steps = [
  {
    ...
    description:
      'Use the visual builder to create a custom cookie banner that matches your Shopify theme.',
    icon: Palette,
  },
  {
    number: '02',
  ...
  },
  {
    ...
    title: 'Publish & Done',
    description:
      'Publish your store and you are compliant. The banner automatically handles all consent management.',
    icon: CheckCircle2,
  },
]

const sellingPoints = [
  { text: 'No Monthly Fees vs $300+/Month Apps' },
  { text: '10x Faster Than Cookiebot & OneTrust' },
  { text: 'E-commerce Optimized for Conversions' },
]
              ...
              >
                <h1 className="font-heading text-3xl font-semibold leading-tight tracking-tight sm:text-4xl md:text-5xl lg:text-6xl text-foreground">
                  ...
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-foreground/90 via-foreground to-foreground/90">
                    No App Required, 5-Minute Setup
                  </span>
                </h1>
              ...
              {[
                {
                  ...
                  desc: 'Paste a single script into your Shopify theme',
                },
                {
                  icon: Shield,
                ...
                },
                {
                  icon: Zap,
                  title: 'Under 10KB',
                  desc: 'No impact on store load speed',
                },
              ].map((item, i) => {
        ...
        <section className="relative overflow-hidden bg-muted border-t border-border px-4 py-16 sm:px-6 sm:py-20">
          ...
          <div className="container relative z-10">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="mb-8 space-y-2 text-lg text-muted-foreground sm:mb-10">
                {sellingPoints.map((point) => (
                  <p key={point.text} className="flex items-center justify-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span className="font-medium">{point.text}</span>
