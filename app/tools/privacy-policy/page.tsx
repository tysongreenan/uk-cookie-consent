  ...
  const faqItems = [
    {
      ...
      answer: "Yes. You can generate, copy, and download a privacy policy with no signup and no credit card. A free account is optional if you want to come back later. Paid plans add hosted policy pages with a custom URL, automatic updates, and version history."
    },
    {
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    <span className="text-xs text-muted-foreground">No signup required to generate, copy, or download</span>
                  </div>
                  <h1 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">
                    Privacy Policy Generator
                  </h1>
                  <p className="text-muted-foreground mt-1">
                    Answer a few questions. Get a GDPR, PIPEDA, CCPA &amp; Law 25 policy in English or French. Copy or download immediately — Pro hosts it for you.
                  </p>
                </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Card>
                  ...
                  <CardContent className="text-sm text-muted-foreground space-y-2">
                    ...
                    <p className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
                      Copy HTML and download with no account
                    </p>
                    <p className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
