...
const LANGUAGES = [
  ...
  { code: 'ja', name: 'Japanese', native: '日本語', title: 'Cookieの使用について', accept: 'すべて許可', reject: '拒否', necessary: '必須Cookie', functional: '機能Cookie', performance: 'パフォーマンスCookie', targeting: 'ターゲティングCookie' },
