...
`}var y="cb-a11y-host",Ot="cb-a11y-adjust";function l(t,e={},n=[]){let r=document.createElement(t);for(let[i,a]of Object.entries(e))a==null||a===!1||(i==="class"?r.className=String(a):i==="text"?r.textContent=String(a):i==="html"?r.innerHTML=String(a):r.setAttribute(i,a===!0?"":String(a)));for(let i of n)i!=null&&r.appendChild(typeof i=="string"?document.createTextNode(i):i);return r}function A(t,e=24){let n=document.createElementNS("http://www.w3.org/2000/svg","svg");return n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("width",String(e)),n.setAttribute("height",String(e)),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","1.9"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.setAttribute("aria-hidden","true"),n.setAttribute("focusable","false"),n.innerHTML=t,n}function R(t,e){return t.replace(/\{(\w+)\}/g,(n,r)=>r in e?String(e[r]):`{${r}}`)}function It(t){let e=$t(t);if(!e)return"#ffffff";let[n,r,i]=e.map(s=>{let c=s/255;return c<=.03928?c/12.92:Math.pow((c+.055)/1.055,2.4)});return .2126*n+.7152*r+.0722*i>.45?"#111111":"#ffffff"}function Tt([t,e,n]){let r=i=>{let a=i/255;return a<=.03928?a/12.92:Math.pow((a+.055)/1.055,2.4)};return .2126*r(t)+.7152*r(e)+.0722*r(n)}function Ze(t,e){let n=Tt(t),r=Tt(e);return(Math.max(n,r)+.05)/(Math.min(n,r)+.05)}function $t(t){let e=/^#([0-9a-f]{3,8})$/i.exec(t.trim());if(e){let r=e[1];return(r.length===3||r.length===4)&&(r=r.split("").map(i=>i+i).join("")),[parseInt(r.slice(0,2),16),parseInt(r.slice(2,4),16),parseInt(r.slice(4,6),16)]}let n=/^rgba?\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)/i.exec(t);return n?[Number(n[1]),Number(n[2]),Number(n[3])]:null}function ae(t,e){let n=$t(t),r=$t(e);if(!n||!r)return t;let i=Tt(r)>.4?[0,0,0]:[255,255,255];for(let a=0;a<=1.0001;a+=.05){let s=n.map((c,u)=>Math.round(c+(i[u]-c)*a));if(Ze(s,r)>=4.5)return`rgb(${s.join(",")})`}return i[0]===0?"#111111":"#ffffff"}function se(){try{return window.matchMedia("(max-width: 767px)").matches}catch(t){return!1}}function le(){try{return window.matchMedia("(prefers-color-scheme: dark)").matches}catch(t){return!1}}function _(t){var r;let e=typeof t.composedPath=="function"?t.composedPath():[],n=e.length?e:[t.target];for(let i of n)if(i instanceof Element)return i.id===y||(r=i.closest)!=null&&r.call(i,`#${y}`)?null:i;return null}function ce(t){return Array.from(t.querySelectorAll('button:not([disabled]),[href],input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])')).filter(e=>e.offsetParent!==null||e.getClientRects().length>0)}var de={monochrome:"grayscale(1)",lowSaturation:"saturate(0.5)",highSaturation:"saturate(2)",highContrast:"contrast(1.7)"},Ht=Object.keys(de),I=null;function Qe(){try{return typeof CSS!="undefined"&&(CSS.supports("backdrop-filter","grayscale(1)")||CSS.supports("-webkit-backdrop-filter","grayscale(1)"))}catch(t){return!1}}function ue(t,e){let n=Ht.filter(i=>e[i]).map(i=>de[i]).join(" "),r=document.documentElement;if(!Qe()){r.classList.add("cb-a11y-nobf");return}if(r.classList.remove("cb-a11y-nobf"),!n){I==null||I.remove(),I=null;return}I||(I=l("div",{class:"cb-a11y-overlay","aria-hidden":"true"}),t.insertBefore(I,t.firstChild)),I.style.setProperty("backdrop-filter",n),I.style.setProperty("-webkit-backdrop-filter",n)}var bt="data-cb-a11y-fs",Pt="data-cb-a11y-fs-inline",tn=6e3,en=new Set(["SCRIPT","STYLE","NOSCRIPT","TEMPLATE","SVG","PATH","IFRAME","CANVAS","VIDEO","AUDIO"]),yt=1,q=null,Q=null;function nn(t){for(let e of Array.from(t.childNodes))if(e.nodeType===3&&(e.textContent||"").trim())return!0;return!1}function rn(t,e){let n=parseFloat(t.getAttribute(bt)||"");if(!Number.isFinite(n)){if(n=parseFloat(getComputedStyle(t).fontSize),!Number.isFinite(n)||n<=0)return;t.setAttribute(bt,String(n));let r=t.style.getPropertyValue("font-size");r&&t.setAttribute(Pt,`${r}${t.style.getPropertyPriority("font-size")==="important"?"!":""}`)}t.style.setProperty("font-size",`${Math.round(on(n,e)*100)/100}px`,"important")}function on(t,e){let n=t*e;return e>=1.4?Math.max(n,18):e>1?Math.max(n,15):n}function pe(t,e){let n=t.querySelectorAll("body *"),r=Math.min(n.length,tn);for(let i=0;i<r;i++){let a=n[i];en.has(a.tagName.toUpperCase())||a.id===y||a.closest(`#${y}`)||!nn(a)&&!a.matches("input,textarea,select,button")||rn(a,e)}}function an(){document.querySelectorAll(`[${bt}]`).forEach(t=>{let e=t.getAttribute(Pt);if(e){let n=e.endsWith("!");t.style.setProperty("font-size",n?e.slice(0,-1):e,n?"important":"")}else t.style.removeProperty("font-size");t.removeAttribute(bt),t.removeAttribute(Pt)})}function fe(t){let e=t/100;if(e===1){yt=1,an(),ln();return}yt=e,pe(document,e),sn()}function sn(){q||typeof MutationObserver=="undefined"||(q=new MutationObserver(()=>{Q===null&&(Q=window.setTimeout(()=>{Q=null,yt!==1&&pe(document,yt)},250))}),q.observe(document.body,{childList:!0,subtree:!0}))}function ln(){q==null||q.disconnect(),q=null,Q!==null&&(clearTimeout(Q),Q=null)}function me(t){var r;let e=(r=t.effect)==null?void 0:r.target,n=e==null?void 0:e.getRootNode();return!!(n&&n.host&&n.host.id===y)}var zt=new WeakSet,Rt=new WeakSet,G=null,W=null;function vt(){return Array.from(document.querySelectorAll("audio,video"))}function ge(t){if(t){let e=()=>vt().forEach(n=>{n.muted||(n.muted=!0,zt.add(n))});e(),!G&&typeof MutationObserver!="undefined"&&(G=new MutationObserver(e),G.observe(document.body,{childList:!0,subtree:!0}))}else G==null||G.disconnect(),G=null,vt().forEach(e=>{zt.has(e)&&(e.muted=!1,zt.delete(e))})}function he(t){var e;if(t){let n=()=>{var r;vt().forEach(i=>{i.paused||(i.pause(),Rt.add(i)),i.removeAttribute("autoplay")});try{(r=document.getAnimations)==null||r.call(document).forEach(i=>{me(i)||i.pause()})}catch(i){}};n(),!W&&typeof MutationObserver!="undefined"&&(W=new MutationObserver(n),W.observe(document.body,{childList:!0,subtree:!0}))}else{W==null||W.disconnect(),W=null;try{(e=document.getAnimations)==null||e.call(document).forEach(n=>{n.playState==="paused"&&!me(n)&&n.play()})}catch(n){}vt().forEach(n=>{Rt.has(n)&&(n.play().catch(()=>{}),Rt.delete(n))})}}var H=null,Y=null;function be(t,e){e&&!H?(H=l("div",{class:"cb-a11y-guide","aria-hidden":"true"}),H.style.transform=`translateY(${Math.round(window.innerHeight*.4)}px)`,t.root.appendChild(H),Y=n=>{H&&(H.style.transform=`translateY(${n.clientY-6}px)`)},document.addEventListener("pointermove",Y,{passive:!0}),document.addEventListener("pointerdown",Y,{passive:!0})):!e&&H&&(H.remove(),H=null,Y&&(document.removeEventListener("pointermove",Y),document.removeEventListener("pointerdown",Y)),Y=null)}var cn="p,li,h1,h2,h3,h4,h5,h6,blockquote,figure,td,th,dt,dd,pre,label,button,a,summary,article,section,aside,nav,header,footer,form,img,video",$=null,P=null,_t=0,ot=null;function dn(t,e){let n=document.elementFromPoint(t,e);if(!n||n.id===y||n.closest(`#${y}`))return null;let r=n.closest(cn);return!r||r===document.body||r===document.documentElement?null:r}function un(){if(_t=0,!$||!ot)return;let t=dn(ot.x,ot.y);if(!t)return;let e=t.getBoundingClientRect(),n=8;$.style.opacity="1",$.style.transform=`translate(${e.left-n}px, ${e.top-n}px)`,$.style.width=`${e.width+n*2}px`,$.style.height=`${e.height+n*2}px`}function ye(t,e){e&&!$?($=l("div",{class:"cb-a11y-focus-hole","aria-hidden":"true"}),t.root.appendChild($),P=n=>{typeof n.clientX=="number"&&(ot={x:n.clientX,y:n.clientY}),_t||(_t=requestAnimationFrame(un))},document.addEventListener("pointermove",P,{passive:!0}),document.addEventListener("pointerdown",P,{passive:!0}),document.addEventListener("scroll",P,{passive:!0,capture:!0})):!e&&$&&($.remove(),$=null,P&&(document.removeEventListener("pointermove",P),document.removeEventListener("pointerdown",P),document.removeEventListener("scroll",P,{capture:!0})),P=null,ot=null)}var x=null,z=null,it=null;function pn(t,e){var s,c,u;let n=t.closest('img,[role="img"],svg,picture,figure');if(!n)return{text:"",missing:!1};if(n.getAttribute("aria-hidden")==="true"||/^(presentation|none)$/.test(n.getAttribute("role")||""))return{text:"",missing:!1};let r=n.getAttribute("alt");if(r!==null&&r.trim()==="")return{text:"",missing:!1};let a=(n.getAttribute("aria-labelledby")||"").trim().split(/\s+/).filter(Boolean).map(g=>{var w;return((w=document.getElementById(g))==null?void 0:w.textContent)||""}).join(" ").trim()||r||n.getAttribute("aria-label")||n.getAttribute("title")||((s=n.querySelector("title"))==null?void 0:s.textContent)||((c=n.querySelector("figcaption"))==null?void 0:c.textContent)||(n.tagName==="PICTURE"?(u=n.querySelector("img"))==null?void 0:u.getAttribute("alt"):null)||null;return a===null?{text:e,missing:!0}:String(a).trim()===""?{text:"",missing:!1}:{text:String(a).trim(),missing:!1}}function fn(t,e,n){let r=Math.min(e+14,window.innerWidth-t.offsetWidth-8),i=Math.min(n+18,window.innerHeight-t.offsetHeight-8);t.style.transform=`translate(${Math.max(8,r)}px, ${Math.max(8,i)}px)`}function ve(t,e){if(e&&!x){x=l("div",{class:"cb-a11y-tip",role:"tooltip",hidden:!0}),t.root.appendChild(x);let n=(r,i,a)=>{if(!x||!r){x&&(x.hidden=!0);return}let s=pn(r,t.strings.missingAlt);if(!s.text){x.hidden=!0;return}x.textContent=s.text,x.classList.toggle("is-missing",s.missing),x.hidden=!1,fn(x,i,a)};z=r=>{let i=_(r);if(!i){x&&(x.hidden=!0);return}let a=r;n(i,"clientX"in a?a.clientX:0,"clientY"in a?a.clientY:0)},it=r=>{var c,u,g;let i=r.relatedTarget;if(i instanceof Node&&((u=(c=r.currentTarget)==null?void 0:c.contains)!=null&&u.call(c,i)))return;let a=i instanceof Element?i.closest('img,[role="img"],svg,picture,figure'):null,s=(g=_(r))==null?void 0:g.closest('img,[role="img"],svg,picture,figure');a&&a===s||x&&(x.hidden=!0)},document.addEventListener("pointerover",z,{passive:!0}),document.addEventListener("pointermove",z,{passive:!0}),document.addEventListener("pointerdown",z,{passive:!0}),document.addEventListener("pointerout",it,{passive:!0})}else!e&&x&&(x.remove(),x=null,z&&(document.removeEventListener("pointerover",z),document.removeEventListener("pointermove",z),document.removeEventListener("pointerdown",z)),it&&document.removeEventListener("pointerout",it),z=it=null)}var Nt="data-cb-a11y-speaking",Ft=800,mn=380,gn=900,hn=80,bn=9e3,yn='p,li,h1,h2,h3,h4,h5,h6,blockquote,td,th,dt,dd,label,button,summary,figcaption,caption,legend,pre,option,abbr,area,[role="button"],[role="img"],img,input,textarea,select,a[href],[contenteditable="true"],[contenteditable=""]',xe="h1,h2,h3,h4,h5,h6,p,li,figcaption,img,blockquote,td,th",N=null,st=null,lt=null,ct=null,dt=null,ut=null,pt=null,ft=null,kt=0,Dt=0,Kt=0,mt=0,X=null,xt=null,we=0,Bt=!1,L=null;function F(){return typeof window!="undefined"&&"speechSynthesis"in window&&typeof SpeechSynthesisUtterance!="undefined"}function wt(t){if(!t||!(t instanceof Element)||t.closest(`#${y}`)||t.closest('[hidden],[aria-hidden="true"],[inert]'))return!0;let e=t.getAttribute("role")||"";if(e==="presentation"||e==="none")return!0;try{let n=getComputedStyle(t);if(n.display==="none"||n.visibility==="hidden")return!0}catch(n){}return!1}function at(t){var n,r;if(!(t instanceof Element)||t.closest(`#${y}`))return null;let e=t;for(;e&&e!==document.documentElement&&e!==document.body;){if(e.id===y||e.tagName==="IFRAME")return null;if((n=e.matches)!=null&&n.call(e,'input:not([type="hidden"]),textarea,select')&&!wt(e)||e instanceof HTMLElement&&e.isContentEditable&&!wt(e))return e;if((r=e.matches)!=null&&r.call(e,yn)&&!wt(e)){if(e.tagName==="A"&&e.querySelector(xe)){let i=t.closest(xe);if(i&&e.contains(i)&&!wt(i))return i}return e}e=e.parentElement}return null}function vn(t){let e=(t.getAttribute("aria-labelledby")||"").trim();return e?e.split(/\s+/).map(n=>{var r;return((r=document.getElementById(n))==null?void 0:r.textContent)||""}).join(" ").replace(/\s+/g," ").trim():""}function xn(t){let e=(t.getAttribute("aria-describedby")||"").trim();return e?e.split(/\s+/).map(n=>{var r;return((r=document.getElementById(n))==null?void 0:r.textContent)||""}).join(" ").replace(/\s+/g," ").trim():""}function wn(t){if(!(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement))return"";if(t.id){let n=typeof CSS!="undefined"&&CSS.escape?CSS.escape(t.id):t.id.replace(/"/g,""),r=document.querySelector(`label[for="${n}"]`);if(r)return(r.textContent||"").replace(/\s+/g," ").trim()}let e=t.closest("label");return e?(e.textContent||"").replace(/\s+/g," ").trim():""}function kn(t){if(t instanceof HTMLImageElement)return(t.alt||"").trim();let e=[],n=(r,i)=>{if(r.nodeType===3){let a=(r.textContent||"").replace(/\s+/g," ");a.trim()&&e.push(a);return}if(r instanceof Element&&!r.closest(`#${y}`)&&!(r.getAttribute("aria-hidden")==="true"||r.hasAttribute("hidden"))&&!r.matches("script,style,noscript,template,svg")&&!(i.tagName==="LI"&&r!==i&&r.matches("ul,ol")))for(let a of Array.from(r.childNodes))n(a,i)};return n(t,t),e.join(" ").replace(/\s+/g," ").trim()}function En(t){var e;return t.tagName!=="SVG"&&t.getAttribute("role")!=="img"?"":(t.getAttribute("aria-label")||"").trim()||(((e=t.querySelector("title"))==null?void 0:e.textContent)||"").replace(/\s+/g," ").trim()}function Se(t){let e=t.closest("figure"),n=e==null?void 0:e.querySelector("figcaption");return n?(n.textContent||"").replace(/\s+/g," ").trim():""}function Sn(t){if(t.tagName!=="TD")return"";let e=t.closest("tr"),n=t.closest("table");if(!e||!n)return"";let r=Array.from(e.children).indexOf(t);if(r<0)return"";let i=n.querySelector(`thead tr th:nth-child(${r+1})`)||e.querySelector("th")||n.querySelector(`tr:first-child th:nth-child(${r+1})`);return i?(i.textContent||"").replace(/\s+/g," ").trim():""}function Mn(t){let e=vn(t);if(e)return e;let n=(t.getAttribute("aria-label")||"").trim();if(n)return n;if(t instanceof HTMLImageElement){let u=(t.alt||"").trim();return u||Se(t)}if(t.tagName==="AREA")return(t.getAttribute("alt")||"").trim();let r=En(t);if(r)return r;let i=wn(t);if(i)return i;let a=kn(t),s=(t.getAttribute("title")||"").trim(),c=t.tagName==="ABBR"?s:"";return a||s||c}function An(t,e){let n=t.tagName;return/^H[1-6]$/.test(n)?R(e.speakHeading,{n:n.slice(1)}):n==="A"||t.getAttribute("role")==="link"?e.speakLink:n==="BUTTON"||t.getAttribute("role")==="button"?e.speakButton:n==="IMG"||t.getAttribute("role")==="img"||n==="AREA"?e.speakImage:""}function Ln(t,e){var n;return t instanceof HTMLInputElement?t.type==="password"?"":t.type==="checkbox"||t.type==="radio"?t.checked?e.speakChecked:e.speakNotChecked:t.value.trim():t instanceof HTMLTextAreaElement?t.value.trim():t instanceof HTMLSelectElement?(((n=t.selectedOptions[0])==null?void 0:n.text)||t.value||"").trim():""}function Me(t){if(t.length<=Ft)return t;let e=t.slice(0,Ft),n=Math.max(e.lastIndexOf(". "),e.lastIndexOf("? "),e.lastIndexOf("! "));return(n>Ft*.5?e.slice(0,n+1):e).trim()}function Cn(t,e){if(t instanceof HTMLImageElement){if(t.getAttribute("aria-hidden")==="true"||/^(presentation|none)$/.test(t.getAttribute("role")||"")||t.getAttribute("alt")==="")return"";if(t.getAttribute("alt")===null&&!t.getAttribute("aria-label")&&!Se(t))return`${e.speakImage}. ${e.speakImageMissing}`}let n=Mn(t),r=An(t,e),i=[],a=Sn(t);a&&a!==n&&i.push(a);let s=Ln(t,e);s&&s!==n&&i.push(s),t instanceof HTMLElement&&t.hasAttribute("required")&&i.push(e.speakRequired),t.getAttribute("aria-invalid")==="true"&&i.push(e.speakInvalid);let c=xn(t);if(c&&c!==n&&i.push(c),!n&&!r&&i.length===0)return"";let u=[r,n,...i].filter(Boolean);return Me(u.join(". ").replace(/\s+/g," ").trim())}function ke(){try{let t=window.getSelection();if(!t||t.isCollapsed)return"";let e=t.toString().replace(/\s+/g," ").trim();return e.length>=2?Me(e):""}catch(t){return""}}function gt(t){document.querySelectorAll(`[${Nt}]`).forEach(e=>e.removeAttribute(Nt)),t instanceof HTMLElement&&t.setAttribute(Nt,"")}function Tn(t){try{let e=speechSynthesis.getVoices();if(!e.length)return null;let n=(t||"en").slice(0,2).toLowerCase();return e.find(r=>r.lang.toLowerCase().startsWith(n)&&r.localService)||e.find(r=>r.lang.toLowerCase().startsWith(n))||null}catch(e){return null}}function Ae(){if(!(Bt||!F()))try{speechSynthesis.getVoices().length?Bt=!0:speechSynthesis.addEventListener("voiceschanged",()=>{Bt=!0},{once:!0})}catch(t){}}function $n(){mt||!F()||(mt=window.setInterval(()=>{try{speechSynthesis.speaking&&!speechSynthesis.paused&&(speechSynthesis.pause(),speechSynthesis.resume())}catch(t){}},bn))}function On(){mt&&(clearInterval(mt),mt=0)}function tt(){clearTimeout(Dt);try{speechSynthesis.cancel()}catch(t){}X=null,gt(null)}function jt(t,e,n=!1){if(!F())return;let r=(t||"").replace(/\s+/g," ").trim();r&&(Ae(),X=null,gt(null),Ut(r,e,null,n))}function In(t,e){var n;return(((n=t==null?void 0:t.closest("[lang]"))==null?void 0:n.getAttribute("lang"))||document.documentElement.lang||e||"en").slice(0,8)}function Ut(t,e,n,r=!1){if(!t)return;try{speechSynthesis.paused&&speechSynthesis.resume(),(speechSynthesis.speaking||speechSynthesis.pending)&&speechSynthesis.cancel()}catch(a){}clearTimeout(Dt);let i=()=>{try{let a=new SpeechSynthesisUtterance(t);a.lang=In(n,e),a.rate=.92;let s=Tn(a.lang);s&&(a.voice=s),a.onend=a.onerror=()=>{X===n&&(X=null),gt(null)},$n(),speechSynthesis.speak(a)}catch(a){}};r?i():Dt=window.setTimeout(i,hn)}function Vt(t,e,n,r=!1){if(t===X)return;let i=Cn(t,n);if(i){if(X=t,gt(t),t instanceof HTMLElement)try{let a=t.getBoundingClientRect(),s=document.documentElement.clientHeight||window.innerHeight;(a.bottom<0||a.top>s)&&t.scrollIntoView({block:"nearest",inline:"nearest"})}catch(a){}Ut(i,e,t,r)}}function Ee(){N&&document.removeEventListener("mouseover",N),st&&document.removeEventListener("mouseout",st),lt&&document.removeEventListener("focusin",lt),dt&&document.removeEventListener("pointerdown",dt),ut&&document.removeEventListener("selectionchange",ut),ct&&document.removeEventListener("keydown",ct),pt&&document.removeEventListener("visibilitychange",pt),ft&&window.removeEventListener("pagehide",ft),N=st=lt=ct=dt=ut=pt=ft=L=null,clearTimeout(kt),clearTimeout(Kt),On(),tt()}function Le(t,e){if(!e){N&&Ee();return}if(!F()){N&&Ee(),t.announce(t.strings.ttsUnavailable);return}L={lang:t.lang==="auto"?navigator.language:t.lang,strings:t.strings},!N&&(Ae(),N=n=>{if(!L||Date.now()-we<gn||ke())return;let r=at(_(n));clearTimeout(kt),xt=r,r&&(kt=window.setTimeout(()=>{xt===r&&L&&Vt(r,L.lang,L.strings)},mn))},st=n=>{let r=at(_(n)),i=at(n.relatedTarget);r&&i!==r&&(clearTimeout(kt),xt===r&&(xt=null))},lt=n=>{if(!L)return;let r=at(_(n));r&&Vt(r,L.lang,L.strings)},dt=n=>{if(n.pointerType==="mouse")return;we=Date.now();let r=at(_(n));!r||!L||Vt(r,L.lang,L.strings,!0)},ut=()=>{clearTimeout(Kt),Kt=window.setTimeout(()=>{let n=ke();!n||!L||(X=null,gt(null),Ut(n,L.lang,null))},400)},ct=n=>{n.key==="Escape"&&(tt(),n.stopPropagation())},pt=()=>{document.hidden&&tt()},ft=()=>tt(),document.addEventListener("mouseover",N,{passive:!0}),document.addEventListener("mouseout",st,{passive:!0}),document.addEventListener("focusin",lt),document.addEventListener("pointerdown",dt,{passive:!0}),document.addEventListener("selectionchange",ut),document.addEventListener("keydown",ct),document.addEventListener("visibilitychange",pt),window.addEventListener("pagehide",ft))}var Hn=["dyslexiaFont","highlightLinks","highlightTitles","focusRing","bigCursor","stopAnimations","hideImages","lightContrast","darkContrast","readAloud","monochrome","lowSaturation","highSaturation","highContrast"];function Pn(t){if(document.getElementById(Ot))return;let e=document.createElement("style");e.id=Ot,e.textContent=oe(t),document.head.appendChild(e)}function qt(t,e){let n=document.documentElement;for(let r=1;r<=3;r++)n.classList.toggle(`${t}-${r}`,e===r)}function Et(t){let{prefs:e}=t,n=document.documentElement,r=e.toggles;(e.fontSize!==100||e.fontWeight||e.lineHeight||e.letterSpacing||Object.keys(r).some(a=>r[a]))&&Pn(t.cfg.assetsBase);for(let a of Hn)n.classList.toggle(`cb-a11y-${a}`,!!r[a]);qt("cb-a11y-fw",e.fontWeight),qt("cb-a11y-lh",e.lineHeight),qt("cb-a11y-ls",e.letterSpacing),n.classList.toggle("cb-a11y-enlarge",e.fontSize>100),B(()=>fe(e.fontSize)),B(()=>ue(t.root,Object.fromEntries(Ht.map(a=>[a,r[a]])))),B(()=>he(!!r.stopAnimations)),B(()=>ge(!!r.muteSounds)),B(()=>be(t,!!r.readingGuide)),B(()=>ye(t,!!r.superFocus)),B(()=>ve(t,!!r.imageTooltips)),B(()=>Le(t,!!r.readAloud))}function B(t){try{t()}catch(e){try{console.warn("[Accessibility Menu] adjustment failed:",e)}catch(n){}}}var Ce="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif";function zn(t){if(typeof t!="string")return"";let e=t.trim().slice(0,80);return!e||!/^[A-Za-z][A-Za-z0-9 \-]*$/.test(e)?"":e}function Te(t){return/\s/.test(t)?`"${t}"`:t}function $e(t,e){let n=zn(t),r=e.trim();return r&&(!n||r.toLowerCase().includes(n.toLowerCase()))?r:n&&r?`${Te(n)}, ${r}`:n?`${Te(n)}, ${Ce}`:r||Ce}function Oe(){try{return document.body&&getComputedStyle(document.body).fontFamily||getComputedStyle(document.documentElement).fontFamily||""}catch(t){return""}}var Ie=`:host {
  all: initial;
  display: block;
  position: fixed;
  inset: auto;
...
`;var Wt="cb-a11y-prefs";var _n=[["monochrome","lowSaturation","highSaturation"],["highContrast","lightContrast","darkContrast"]];function et(){return{v:1,fontSize:100,fontWeight:0,lineHeight:0,letterSpacing:0,toggles:{},profile:null,lang:null,menuVoice:!1}}function He(){try{let t=localStorage.getItem(Wt);if(!t)return et();let e=JSON.parse(t);if(!e||e.v!==1)return et();let n=et();return n.fontSize=Pe(Number(e.fontSize)),n.fontWeight=Gt(e.fontWeight),n.lineHeight=Gt(e.lineHeight),n.letterSpacing=Gt(e.letterSpacing),n.toggles=e.toggles&&typeof e.toggles=="object"?{...e.toggles}:{},n.profile=typeof e.profile=="string"?e.profile:null,n.lang=typeof e.lang=="string"?e.lang:null,n.menuVoice=e.menuVoice===!0,n}catch(t){return et()}}function Yt(t){try{Nn(t)?localStorage.removeItem(Wt):localStorage.setItem(Wt,JSON.stringify(t))}catch(e){}}function Nn(t){return t.fontSize===100&&t.fontWeight===0&&t.lineHeight===0&&t.letterSpacing===0&&t.profile===null&&t.lang===null&&!t.menuVoice&&!Object.keys(t.toggles).some(e=>t.toggles[e])}function Pe(t){if(!Number.isFinite(t))return 100;let e=Math.round(t/10)*10;return Math.min(200,Math.max(80,e))}function Gt(t){let e=typeof t=="number"?Math.round(t):0;return Math.min(3,Math.max(0,Number.isFinite(e)?e:0))}function ze(t,e,n){if(n){for(let r of _n)if(r.includes(e))for(let i of r)i!==e&&delete t.toggles[i];t.toggles[e]=!0}else delete t.toggles[e];t.profile=null}function Re(t,e){return t[e]=(t[e]+1)%4,t.profile=null,t[e]}function _e(t,e){return t.fontSize=Pe(t.fontSize+e*10),t.profile=null,t.fontSize}var Fn={seizureSafe:{toggles:{stopAnimations:!0,lowSaturation:!0,muteSounds:!0}},readAloud:{toggles:{readAloud:!0}},visuallyImpaired:{fontSize:150,fontWeight:1,lineHeight:1,letterSpacing:1,toggles:{lightContrast:!0,highlightLinks:!0,highlightTitles:!0,bigCursor:!0,focusRing:!0,imageTooltips:!0,readingGuide:!0}},adhd:{toggles:{superFocus:!0,stopAnimations:!0,muteSounds:!0}},cognitive:{toggles:{readingGuide:!0,highlightTitles:!0,highlightLinks:!0,dyslexiaFont:!0},lineHeight:1},motorImpaired:{fontSize:110,toggles:{bigCursor:!0,focusRing:!0,highlightLinks:!0}}};function Ne(t,e){let n=t.lang,r=t.menuVoice,i=et();if(i.lang=n,i.menuVoice=r,e){let a=Fn[e];Object.assign(i,a,{toggles:{...a.toggles||{}},profile:e,lang:n,menuVoice:r})}Object.assign(t,i)}function Fe(t){let e=t.lang;Object.assign(t,et()),t.lang=e}var Bn=["bg","card","card-2","text","muted","border","control","tint"];function Xt(t,e,n){let r=e.surface,i=(r==null?void 0:r.theme)||n;if(t.setAttribute("data-theme",i),t.style.setProperty("--accent",e.accent),t.style.setProperty("--accent-text",e.accentText||It(e.accent)),t.style.setProperty("--header-bg",e.headerBg||e.accent),t.style.setProperty("--header-fg",e.headerFg||e.accentText||It(e.accent)),r)t.style.setProperty("--bg",r.bg),t.style.setProperty("--card",r.card),t.style.setProperty("--card-2",r.card2),t.style.setProperty("--text",r.text),t.style.setProperty("--muted",r.muted),t.style.setProperty("--border",r.border),t.style.setProperty("--control",r.control),t.style.setProperty("--tint",r.tint);else for(let s of Bn)t.style.removeProperty(`--${s}`);let a=(r==null?void 0:r.card2)||(i==="dark"?"#262a35":"#f7f8fb");t.style.setProperty("--accent-ink",ae(e.accent,a))}var Vn=[['header,[role="banner"]',"header"],['nav,[role="navigation"]',"nav"],['main,[role="main"]',"main"],['aside,[role="complementary"]',"aside"],['form,[role="form"],[role="search"]',"form"],['footer,[role="contentinfo"]',"footer"]];function Jt(t){if(t.closest(`#${y},[hidden],[aria-hidden="true"]`))return!1;let e=t.getBoundingClientRect();return e.width>0||e.height>0?!0:getComputedStyle(t).display!=="none"}function Be(t){return t.getAttribute("aria-label")||(t.innerText||t.textContent||"").replace(/\s+/g," ").trim().slice(0,120)}function Dn(){let t=[];document.querySelectorAll('h1,h2,h3,h4,h5,h6,[role="heading"]').forEach(i=>{if(!Jt(i))return;let a=i.getAttribute("aria-level")||i.tagName.replace(/\D/g,"")||"2",s=Be(i);s&&t.push({label:s,meta:`H${a}`,el:i})});let e=[],n=new Set;for(let[i,a]of Vn)document.querySelectorAll(i).forEach(s=>{n.has(s)||!Jt(s)||(n.add(s),e.push({label:s.getAttribute("aria-label")||a,meta:a,el:s}))});let r=[];return document.querySelectorAll("a[href]").forEach(i=>{var s;if(r.length>=200||!Jt(i))return;let a=Be(i)||((s=i.querySelector("img"))==null?void 0:s.alt)||"";a&&r.push({label:a,meta:"",el:i})}),{headings:t,landmarks:e,links:r}}function Ve(t){let e=t,n=e.hasAttribute("tabindex");n||e.setAttribute("tabindex","-1"),e.scrollIntoView({block:"center"}),e.focus({preventScroll:!0}),n||e.addEventListener("blur",()=>e.removeAttribute("tabindex"),{once:!0})}function De(t,e){let n=Dn(),r=(i,a,s=!1)=>{let c=l("ul",{class:"cb-a11y-struct-list"});a.length||c.appendChild(l("li",{class:"cb-a11y-struct-empty",text:t.structureEmpty}));for(let u of a){let g=l("button",{type:"button",class:"cb-a11y-struct-item"},[u.meta?l("span",{class:"cb-a11y-struct-meta",text:u.meta}):null,l("span",{text:u.label})]);s&&u.meta&&(g.style.paddingLeft=`${8+(Number(u.meta.slice(1))-1)*12}px`),g.addEventListener("click",()=>e(u.el)),c.appendChild(l("li",{},[g]))}return l("section",{class:"cb-a11y-struct-section"},[l("h3",{text:i}),c])};return l("div",{class:"cb-a11y-struct"},[r(t.structureHeadings,n.headings,!0),r(t.structureLandmarks,n.landmarks),r(t.structureLinks,n.links)])}var E={"universal-access":'<circle cx="12" cy="12" r="10"/><circle cx="12" cy="7" r="1.2" fill="currentColor" stroke="none"/><path d="M6.5 10.5c3.7 1 7.3 1 11 0"/><path d="M12 11v3.5l-2 4.5"/><path d="M12 14.5l2 4.5"/>',wheelchair:'<circle cx="14" cy="4" r="1.5"/><path d="M13 7v5h5l2 5"/><path d="M13 10h4"/><circle cx="10" cy="17" r="4.5"/><path d="M9.5 12.6a4.5 4.5 0 100 8.9"/>',eye:'<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>',close:'<path d="M6 6l12 12M18 6L6 18"/>',reset:'<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/>',menuVoice:'<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M7 11a5 5 0 0010 0"/><path d="M12 16v4M9 20h6"/>',menuVoiceOff:'<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M7 11a5 5 0 0010 0"/><path d="M12 16v4M9 20h6"/><path d="M4 4l16 16"/>',chevron:'<path d="M6 9l6 6 6-6"/>',back:'<path d="M15 6l-6 6 6 6"/>',minus:'<path d="M5 12h14"/>',plus:'<path d="M12 5v14M5 12h14"/>',seizureSafe:'<path d="M4 12h3l2-6 3 12 2-6h6"/><path d="M3 3l18 18"/>',readAloudProfile:'<path d="M4 9v6h3l4 4V5L7 9z"/><path d="M15 9a4 4 0 010 6"/><path d="M17.5 6.5a8 8 0 010 11"/>',visuallyImpaired:'<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>',adhd:'<circle cx="12" cy="12" r="9"/><path d="M12 8v4l2 2"/>',cognitive:'<path d="M12 5.5C10 4 5 4 3 5.5v13c2-1.5 7-1.5 9 0 2-1.5 7-1.5 9 0v-13c-2-1.5-7-1.5-9 0z"/><path d="M12 5.5v13"/>',motorImpaired:'<circle cx="12" cy="12" r="9"/><path d="M12 3v18M3 12h18"/>',fontSize:'<path d="M4 18L9 6l5 12"/><path d="M6 14h6"/><path d="M15 18l2.5-6 2.5 6"/><path d="M16 16h3"/>',fontWeight:'<path d="M7 5h6a3.5 3.5 0 010 7H7z"/><path d="M7 12h7a3.5 3.5 0 010 7H7z"/>',lineHeight:'<path d="M4 5h16M4 19h16"/><path d="M12 8v8"/><path d="M9.5 10.5L12 8l2.5 2.5M9.5 13.5L12 16l2.5-2.5"/>',letterSpacing:'<path d="M4 4v16M20 4v16"/><path d="M8 16l4-8 4 8"/><path d="M9.5 13h5"/>',dyslexiaFont:'<path d="M5 18L9.5 6l4.5 12"/><path d="M6.7 14h5.6"/><path d="M16 12a3 3 0 106 0 3 3 0 10-6 0"/>',highlightLinks:'<path d="M10 14a4 4 0 005.7 0l3-3a4 4 0 00-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 00-5.7 0l-3 3a4 4 0 005.7 5.7l1-1"/>',highlightTitles:'<path d="M5 5h14"/><path d="M12 5v14"/><path d="M8 19h8"/>',superFocus:'<path d="M4 8V5a1 1 0 011-1h3M16 4h3a1 1 0 011 1v3M20 16v3a1 1 0 01-1 1h-3M8 20H5a1 1 0 01-1-1v-3"/><circle cx="12" cy="12" r="3.5"/>',readAloud:'<path d="M4 9v6h3l4 4V5L7 9z"/><path d="M15 9a4 4 0 010 6"/><path d="M17.5 6.5a8 8 0 010 11"/>',readingGuide:'<path d="M12 5.5C10 4 5 4 3 5.5v13c2-1.5 7-1.5 9 0 2-1.5 7-1.5 9 0v-13c-2-1.5-7-1.5-9 0z"/><path d="M6 10h4M14 10h4M6 13h4M14 13h4"/>',bigCursor:'<path d="M5 3l14 8.5-6.2 1.6L9.3 20z"/>',pageStructure:'<path d="M4 6l8-3 8 3-8 3z"/><path d="M4 12l8 3 8-3"/><path d="M4 18l8 3 8-3"/>',monochrome:'<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M4 20L20 4"/><path d="M12 4v16" stroke-dasharray="2 2"/>',lowSaturation:'<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M8 4v16M12 4v16M16 4v16M4 8h16M4 12h16M4 16h16"/>',highSaturation:'<circle cx="12" cy="12" r="3"/><path d="M12 3v3M12 18v3M3 12h3M18 12h3M5.6 5.6l2.2 2.2M16.2 16.2l2.2 2.2M5.6 18.4l2.2-2.2M16.2 7.8l2.2-2.2"/>',highContrast:'<circle cx="12" cy="12" r="9"/><path d="M12 3v18"/><path d="M12 3a9 9 0 010 18z" fill="currentColor" stroke="none"/>',lightContrast:'<circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/>',darkContrast:'<path d="M20 14.5A8.5 8.5 0 019.5 4a8.5 8.5 0 1010.5 10.5z"/>',stopAnimations:'<circle cx="12" cy="12" r="9"/><path d="M10 9v6M14 9v6"/>',hideImages:'<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 16l5-5 4 4 3-3 6 6"/><path d="M3 3l18 18"/>',imageTooltips:'<rect x="3" y="4" width="18" height="12" rx="2"/><path d="M8 20h8M12 16v4"/><path d="M7 9h10M7 12h6"/>',muteSounds:'<path d="M4 9v6h3l4 4V5L7 9z"/><path d="M16 9l5 6M21 9l-5 6"/>',external:'<path d="M14 4h6v6"/><path d="M20 4l-9 9"/><path d="M19 14v5a1 1 0 01-1 1H5a1 1 0 01-1-1V6a1 1 0 011-1h5"/>',mail:'<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 7l9 6 9-6"/>'};var Ke=["cookie-consent-banner","cookie-settings-float"];function je(){return document.documentElement.clientHeight||window.innerHeight}function Kn(t){if(!t)return null;let e=getComputedStyle(t);if(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")return null;let n=t.getBoundingClientRect();return n.width<=0||n.height<=0||n.bottom<0||n.top>je()||n.right<0||n.left>(document.documentElement.clientWidth||window.innerWidth)?null:n}function jn(t,e){return t.left<e.right+6&&t.right>e.left-6&&t.top<e.bottom+6&&t.bottom>e.top-6}function Zt(t,e){let n=t.style;n.left=n.right=n.top=n.bottom="auto",n.transform="";let r=e.position.endsWith("right")?"right":"left";n[r]=`calc(${e.offsetX}px + env(safe-area-inset-${r}, 0px))`,e.position.startsWith("top")?n.top=`calc(${e.offsetY}px + env(safe-area-inset-top, 0px))`:e.position.startsWith("middle")?(n.top="50%",n.transform="translateY(-50%)"):n.bottom=`calc(${e.offsetY}px + env(safe-area-inset-bottom, 0px))`}function Un(t,e){Zt(t,e);let n=e.position.startsWith("top")?"top":e.position.startsWith("middle")?"middle":"bottom",r=!1;for(let i=0;i<3;i++){let a=t.getBoundingClientRect();if(a.width===0)return r;let s=Ke.map(c=>Kn(document.getElementById(c))).find(c=>c&&jn(a,c));if(!s)return r;r=!0,n==="bottom"?t.style.bottom=`${Math.max(0,je()-s.top+12)}px`:n==="top"?t.style.top=`${s.bottom+12}px`:(t.style.transform="",t.style.top=`${Math.max(12,s.top-a.height-12)}px`)}return r}function Ue(t,e){let n=0,r=[],i=()=>{n||(n=requestAnimationFrame(()=>{n=0;try{Un(t,e)}catch(T){}}))},a=()=>{i(),r.forEach(clearTimeout),r.length=0;for(let T of[120,400,900,1800])r.push(window.setTimeout(i,T))},s=new WeakSet,c=typeof MutationObserver!="undefined"?new MutationObserver(a):null,u=typeof ResizeObserver!="undefined"?new ResizeObserver(i):null,g=()=>{for(let T of Ke){let S=document.getElementById(T);!S||s.has(S)||(s.add(S),c==null||c.observe(S,{attributes:!0,attributeFilter:["style","class","hidden","aria-hidden"]}),u==null||u.observe(S),S.addEventListener("transitionend",i),S.addEventListener("animationend",i))}};g(),a();let w=typeof MutationObserver!="undefined"?new MutationObserver(()=>{g(),a()}):null;return w==null||w.observe(document.body,{childList:!0}),window.addEventListener("resize",i,{passive:!0}),window.addEventListener("orientationchange",a),()=>{w==null||w.disconnect(),c==null||c.disconnect(),u==null||u.disconnect(),window.removeEventListener("resize",i),window.removeEventListener("orientationchange",a),r.forEach(clearTimeout),n&&cancelAnimationFrame(n)}}var Yn=["seizureSafe","readAloud","visuallyImpaired","adhd","cognitive","motorImpaired"],Xn={seizureSafe:"seizureSafe",readAloud:"readAloudProfile",visuallyImpaired:"visuallyImpaired",adhd:"adhd",cognitive:"cognitive",motorImpaired:"motorImpaired"},Jn=[{title:"sectionContent",keys:["fontWeight","lineHeight","letterSpacing","dyslexiaFont","highlightLinks","highlightTitles"]},{title:"sectionVisual",keys:["readAloud","superFocus","readingGuide","bigCursor","pageStructure"]},{title:"sectionColor",keys:["monochrome","lowSaturation","highSaturation","highContrast","lightContrast","darkContrast"]},{title:"sectionTools",keys:["stopAnimations","hideImages","imageTooltips","muteSounds"]}],Zn=["fontWeight","lineHeight","letterSpacing"],Qn={small:40,medium:48,large:56};function qe(t){let{cfg:e,root:n}=t,r=new Set(e.features),i=e.trigger.position.endsWith("right")?"right":"left",a=!1,s="menu",c=null,u=l("button",{type:"button",class:"cb-a11y-trigger","aria-label":t.strings.openMenu,"aria-haspopup":"dialog","aria-expanded":"false","aria-controls":"cb-a11y-panel","data-shape":e.trigger.shape,title:t.strings.openMenu});if(u.style.setProperty("--size-cfg",`${Qn[e.trigger.size]}px`),u.appendChild(A(E[e.trigger.icon]||E["universal-access"])),e.trigger.label&&e.trigger.shape!=="circle"&&u.appendChild(l("span",{text:e.trigger.label})),Zt(u,e.trigger),e.trigger.hideOnMobile){let o=()=>{u.hidden=se()};o();try{window.matchMedia("(max-width: 767px)").addEventListener("change",o)}catch(p){}}let g=l("div",{class:"cb-a11y-scrim"}),w=l("h2",{id:"cb-a11y-title",text:t.strings.menuTitle}),T=l("button",{type:"button",class:"cb-a11y-iconbtn","aria-label":t.strings.closeMenu,hidden:!0},[A(E.back)]),S=l("button",{type:"button",class:"cb-a11y-iconbtn","aria-label":t.strings.resetSettings,title:t.strings.resetSettings},[A(E.reset)]),O=l("button",{type:"button",class:"cb-a11y-iconbtn cb-a11y-voicebtn","aria-label":t.strings.menuVoiceOn,title:t.strings.menuVoiceOn,"aria-pressed":"false"},[A(E.menuVoiceOff)]),V=l("button",{type:"button",class:"cb-a11y-iconbtn","aria-label":t.strings.closeMenu,title:t.strings.closeMenu},[A(E.close)]),Ge=l("div",{class:"cb-a11y-header"},[T,w,O,S,V]),J=l("div",{class:"cb-a11y-body"}),nt=l("div",{class:"cb-a11y-footer"}),D=l("div",{id:"cb-a11y-panel",class:"cb-a11y-panel",role:"dialog","aria-modal":"true","aria-labelledby":"cb-a11y-title","data-side":i,tabindex:"-1"},[Ge,J,nt]),St=l("div",{class:"cb-a11y-sr",role:"status","aria-live":"polite","aria-atomic":"true"});n.append(g,D,u,St),t.announce=o=>{St.textContent="",requestAnimationFrame(()=>St.textContent=o)};function te(){return t.lang==="auto"?navigator.language:t.lang}function ht(o,p=!1){t.prefs.menuVoice&&jt(o,te(),p)}let Mt=0;function ee(){let o=t.prefs.menuVoice,p=t.strings;O.hidden=!F(),O.classList.toggle("is-on",o),O.setAttribute("aria-pressed",String(o)),O.setAttribute("aria-label",o?p.menuVoiceOff:p.menuVoiceOn),O.title=o?p.menuVoiceOff:p.menuVoiceOn,O.replaceChildren(A(E[o?"menuVoice":"menuVoiceOff"]))}function At(o,p){o.addEventListener("pointerenter",h=>{t.prefs.menuVoice&&(Date.now()<Mt||h.pointerType!=="touch"&&ht(p(),!1))}),o.addEventListener("focus",()=>{t.prefs.menuVoice&&(Date.now()<Mt||ht(p(),!1))})}function K(){let o=t.strings;if(w.textContent=s==="menu"?o.menuTitle:o.structureTitle,T.hidden=s==="menu",T.setAttribute("aria-label",o.menuTitle),S.hidden=s!=="menu",u.setAttribute("aria-label",o.openMenu),u.title=o.openMenu,V.setAttribute("aria-label",o.closeMenu),V.title=o.closeMenu,ee(),t.host.setAttribute("dir",t.lang==="ar"||t.lang==="he"?"rtl":"ltr"),J.replaceChildren(),nt.replaceChildren(),s==="structure"){J.appendChild(De(o,m=>{Z(),Ve(m)}));return}let p=Object.keys(e.strings);if(p.length>1){let m=l("select",{class:"cb-a11y-select","aria-label":o.language});for(let f of p){let k=l("option",{value:f,text:e.languageNames[f]||f});f===t.lang&&(k.selected=!0),m.appendChild(k)}m.addEventListener("change",()=>{var f;t.prefs.lang=m.value,Qt(t,m.value),t.save(),K(),(f=n.querySelector(".cb-a11y-select"))==null||f.focus(),t.announce(t.strings.menuTitle)}),J.appendChild(m)}if(r.has("profiles")){let m=l("div",{class:"cb-a11y-card"},[l("h3",{text:o.sectionProfiles})]);for(let f of Yn){if(f==="readAloud"&&(!r.has("readAloud")||!F()))continue;let k=t.prefs.profile===f,C=l("button",{type:"button",class:"cb-a11y-profile",role:"switch","aria-checked":String(k),"aria-label":`${o.profiles[f].name}, ${k?o.speakOn:o.speakOff}`,"data-profile":f},[l("span",{class:"ic","aria-hidden":"true"},[A(E[Xn[f]])]),l("span",{class:"tx"},[l("b",{text:o.profiles[f].name}),l("span",{text:o.profiles[f].description})]),l("span",{class:"cb-a11y-switch","aria-hidden":"true"})]);C.addEventListener("click",()=>{var ie;let b=!k;Ne(t.prefs,k?null:f);let j=f==="readAloud"?b?o.readAloudOnSpeak:o.readAloudOffSpeak:b?R(o.profileApplied,{name:o.profiles[f].name}):R(o.turnedOff,{name:o.profiles[f].name});rt(j),ht(j,!0),t.track("a11y_profile",{profile:f,on:b}),(ie=n.querySelector(`[data-profile="${f}"]`))==null||ie.focus()}),At(C,()=>f==="readAloud"?t.prefs.toggles.readAloud?o.readAloudPreviewOn:o.readAloudPreviewOff:R(o.profilePreview,{name:o.profiles[f].name,state:t.prefs.profile===f?o.speakOn:o.speakOff})),m.appendChild(C)}J.appendChild(m)}for(let m of Jn){let f=m.keys.filter(b=>r.has(b)),k=m.title==="sectionContent";if(!f.length&&!(k&&r.has("fontSize")))continue;let C=l("div",{class:"cb-a11y-card"},[l("h3",{text:o[m.title]})]);if(k&&r.has("fontSize")&&C.appendChild(We()),f.length){let b=l("div",{class:"cb-a11y-grid"});for(let j of f)b.appendChild(Ye(j));C.appendChild(b)}J.appendChild(C)}let h=l("button",{type:"button",class:"cb-a11y-reset",text:o.resetSettings});h.addEventListener("click",()=>{var m;ne(),(m=n.querySelector(".cb-a11y-reset"))==null||m.focus()}),nt.appendChild(h);let v=l("div",{class:"cb-a11y-links"});e.statementUrl&&v.appendChild(l("a",{href:e.statementUrl,target:"_blank",rel:"noopener"},[A(E.external),o.statementLink])),e.feedbackEmail&&v.appendChild(l("a",{href:`mailto:${e.feedbackEmail}?subject=${encodeURIComponent(o.feedbackLink)}`},[A(E.mail),o.feedbackLink])),v.childNodes.length&&nt.appendChild(v);let M=l("p",{class:"cb-a11y-fine",text:o.disclaimer});e.poweredBy&&(M.appendChild(document.createTextNode(" ")),M.appendChild(l("a",{href:"https://www.cookie-banner.ca/?ref=a11y",target:"_blank",rel:"noopener",text:o.poweredBy}))),nt.appendChild(M)}function We(){let o=t.strings,p=l("span",{class:"val","aria-live":"off",text:`${t.prefs.fontSize}%`}),h=l("button",{type:"button",class:"cb-a11y-stepbtn","aria-label":o.fontSizeDecrease},[A(E.minus)]),v=l("button",{type:"button",class:"cb-a11y-stepbtn","aria-label":o.fontSizeIncrease},[A(E.plus)]);h.disabled=t.prefs.fontSize<=80,v.disabled=t.prefs.fontSize>=200;let M=m=>{var k;let f=_e(t.prefs,m);rt(R(o.fontSizeAnnounce,{value:f})),t.track("a11y_toggle",{feature:"fontSize",value:f}),(k=n.querySelector(m===1?".cb-a11y-stepbtn:last-of-type":".cb-a11y-stepbtn"))==null||k.focus()};return h.addEventListener("click",()=>M(-1)),v.addEventListener("click",()=>M(1)),l("div",{class:"cb-a11y-stepper",role:"group","aria-label":`${o.fontSize}, ${t.prefs.fontSize}%`},[l("div",{class:"lb"},[A(E.fontSize),o.fontSize]),h,p,v])}function Ye(o){var k;let p=t.strings,h=p[o],v=Zn.includes(o),M=v?t.prefs[o]:0,m=v?M>0:o==="pageStructure"?!1:!!t.prefs.toggles[o],f=l("button",{type:"button",class:o==="readAloud"?"cb-a11y-tile is-read-aloud":"cb-a11y-tile",role:o==="pageStructure"?null:"switch","aria-checked":o==="pageStructure"?null:String(m),"data-key":o,"aria-label":v?`${h}: ${p.levelLabels[M]||p.levelOff}`:o==="pageStructure"?h:`${h}, ${m?p.speakOn:p.speakOff}`},[A(E[o]),l("span",{class:"tx"},[l("b",{text:h}),v?l("span",{class:"lv-cap",text:p.levelLabels[M]||p.levelOff}):null])]);if(o==="readAloud"&&((k=f.querySelector(".tx"))==null||k.appendChild(l("span",{text:p.readAloudShort}))),v){let C=l("span",{class:"lv","aria-hidden":"true"});for(let b=1;b<=3;b++)C.appendChild(l("i",{class:b<=M?"on":""}));f.appendChild(C)}return o==="readAloud"&&(F()?f.title=t.strings.readAloudHint:(f.disabled=!0,f.title=t.strings.ttsUnavailable),At(f,()=>m?p.readAloudPreviewOn:p.readAloudPreviewOff)),f.addEventListener("click",()=>{var C;if(o==="pageStructure"){s="structure",K(),T.focus(),t.track("a11y_open",{view:"structure"});return}if(v){let b=Re(t.prefs,o);rt(`${h}: ${p.levelLabels[b]||p.levelOff}`),t.track("a11y_toggle",{feature:o,value:b})}else{let b=!m;ze(t.prefs,o,b);let j=o==="readAloud"?b?p.readAloudOnSpeak:p.readAloudOffSpeak:R(b?p.turnedOn:p.turnedOff,{name:h});rt(j),o==="readAloud"&&ht(j,!0),t.track("a11y_toggle",{feature:o,on:b})}(C=n.querySelector(`[data-key="${o}"]`))==null||C.focus()}),f}function rt(o){Mt=Date.now()+600,t.save(),t.render(),K(),t.announce(o)}function ne(){Fe(t.prefs),rt(t.strings.resetDone),t.track("a11y_reset")}function Lt(){if(a)return;a=!0,s="menu";let o=document.activeElement;c=o===t.host?n.activeElement:o,(!c||c===document.body||D.contains(c))&&(c=u),K(),g.classList.add("is-open"),D.classList.add("is-open"),u.setAttribute("aria-expanded","true"),u.style.visibility="hidden",V.focus(),document.addEventListener("keydown",re,!0),t.track("a11y_open")}function Z(){a&&(a=!1,g.classList.remove("is-open"),D.classList.remove("is-open"),u.setAttribute("aria-expanded","false"),u.style.visibility="",document.removeEventListener("keydown",re,!0),(c&&c.isConnected?c:u).focus())}function Ct(){a?Z():Lt()}function re(o){if(o.key==="Escape"){o.preventDefault(),s==="structure"?(s="menu",K(),V.focus()):Z();return}if(o.key!=="Tab")return;let p=ce(D);if(!p.length)return;let h=n.activeElement,v=p[0],M=p[p.length-1];o.shiftKey&&(h===v||!h||!D.contains(h))?(o.preventDefault(),M.focus()):!o.shiftKey&&(h===M||!h||!D.contains(h))&&(o.preventDefault(),v.focus())}return u.addEventListener("click",Ct),At(u,()=>t.strings.openMenu),O.addEventListener("click",()=>{let o=!t.prefs.menuVoice;if(t.prefs.menuVoice=o,t.save(),ee(),t.track("a11y_toggle",{feature:"menuVoice",on:o}),!o){tt(),t.announce(t.strings.menuVoiceOff);return}jt(t.strings.menuVoiceOnSpeak,te(),!0)}),V.addEventListener("click",Z),T.addEventListener("click",()=>{s="menu",K(),V.focus()}),S.addEventListener("click",ne),g.addEventListener("click",Z),e.shortcut!=="none"&&document.addEventListener("keydown",o=>{(e.shortcut==="alt-shift-a"?o.altKey&&o.shiftKey&&(o.key==="A"||o.key==="a"):(o.ctrlKey||o.metaKey)&&!o.shiftKey&&(o.key==="u"||o.key==="U"))&&(o.preventDefault(),Ct())}),e.trigger.customSelector&&document.addEventListener("click",o=>{let p=o.target;p&&p.closest(e.trigger.customSelector)&&(o.preventDefault(),Lt())}),Ue(u,e.trigger),{open:Lt,close:Z,toggle:Ct,render:K}}function Qt(t,e){let n=t.cfg.strings[e]||t.cfg.strings.en||Object.values(t.cfg.strings)[0];t.strings=n,t.lang=e}function er(){if(window.__cbA11yConfig&&typeof window.__cbA11yConfig=="object")return window.__cbA11yConfig;let t=document.currentScript||document.getElementById("cb-a11y-script"),e=t==null?void 0:t.getAttribute("data-cb-a11y");if(!e)return null;try{return JSON.parse(e)}catch(n){return null}}function nr(t,e){let n=Object.keys(t.strings);if(e&&n.includes(e))return e;if(t.lang==="auto"){let r=(navigator.language||"en").slice(0,2).toLowerCase();return n.includes(r)?r:n[0]||"en"}return n.includes(t.lang)?t.lang:n[0]||"en"}function rr(){if(window.__cbA11yBooted||document.getElementById(y))return;let t=er();if(!t||!t.strings||!t.trigger)return;window.__cbA11yBooted=!0;let e=()=>{if(!document.body){setTimeout(e,50);return}let n=$e(t.fontFamily||"",Oe()),r=document.createElement("div");r.id=y,r.style.cssText=`all:initial;display:block;position:fixed;inset:auto;width:0;height:0;z-index:${2147483001};font-family:${n};font-size:15px;line-height:1.4;font-weight:400;letter-spacing:normal;text-transform:none;color:var(--text)`;let i=r.attachShadow({mode:"open"}),a=document.createElement("style");a.textContent=Ie,i.appendChild(a);let s=t.panel.theme==="auto"?le()?"dark":"light":t.panel.theme;Xt(r,t.panel,s),r.style.setProperty("--trigger-bg",t.trigger.colors.background),r.style.setProperty("--trigger-fg",t.trigger.colors.icon),r.style.setProperty("--trigger-border",t.trigger.colors.border),r.style.setProperty("--font",n);let c=He(),u={cfg:t,prefs:c,strings:t.strings.en||Object.values(t.strings)[0],lang:"en",root:i,host:r,announce:()=>{},save:()=>Yt(c),render:()=>Et(u),track:(w,T)=>{var S;try{(S=window.__cbA11yTrack)==null||S.call(window,w,T)}catch(O){}}};Qt(u,nr(t,c.lang)),document.body.appendChild(r);let g=qe(u);if(g.render(),Et(u),t.panel.theme==="auto"&&!t.panel.surface)try{window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",w=>{Xt(r,t.panel,w.matches?"dark":"light")})}catch(w){}window.cbAccessibility={open:g.open,close:g.close,toggle:g.toggle,reset:()=>{c.fontSize=100,c.fontWeight=c.lineHeight=c.letterSpacing=0,c.toggles={},c.profile=null,c.menuVoice=!1,Yt(c),Et(u),g.render()},version:1}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}try{rr()}catch(t){try{console.warn("[Accessibility Menu] failed to start:",t)}catch(e){}}})();
