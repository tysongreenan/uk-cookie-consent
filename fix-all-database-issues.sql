-- Comprehensive database fix for workspace switching system
...
-- 8. Clean up duplicate workspaces (optional - uncomment if needed)
-- This will remove duplicate teams and keep only the oldest one for each user
/*
...
-- 9. Verify the fixes
SELECT 'Project table columns:' as info;
...
SELECT 'TeamInvitation policies:' as info;
SELECT policyname, cmd 
FROM pg_policies 
WHERE tablename = 'TeamInvitation';
