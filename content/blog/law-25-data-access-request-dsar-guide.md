...
published: true
canonical: "/blog/law-25-data-access-request-dsar-guide"
keywords:
  - "law 25 data access request"
  - "quebec data access request"
  - "dsar quebec"
  - "law 25 dsar"
  - "law 25 right of access"
  - "loi 25 demande d'acces"
  - "data subject access request canada"
  - "law 25 compliance"
  - "respond to data access request"
  - "quebec privacy law data request"
schema:
  ...
  mainEntity:
    ...
    - "@type": "Question"
      ...
      acceptedAnswer:
        "@type": "Answer"
        text: "Yes. Law 25 requires organizations to take reasonable measures to verify the identity of the person making the request before releasing any personal information. Accepted methods include government ID verification, email confirmation, or in-person verification."
    - "@type": "Question"
      name: "What data must I include in a Law 25 access report?"
      acceptedAnswer:
        "@type": "Answer"
        text: "You must include all personal information held about the individual, the purposes for which it was collected, the categories of persons who have access to it, and the retention period. For cookie consent platforms, this includes consent records, IP addresses, device information, and analytics data."
    - "@type": "Question"
      name: "Does Law 25 apply to my business outside Quebec?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Law 25 applies if you collect, use, or disclose personal information of Quebec residents, regardless of where your business is located. If your website uses cookies and receives visitors from Quebec, you are likely subject to Law 25."
    - "@type": "Question"
      name: "What is the penalty for not responding to a data access request?"
      acceptedAnswer:
        "@type": "Answer"
...
- [What Is a Law 25 Data Access Request?](#what-is-a-law-25-data-access-request)
- [Who Must Comply with Law 25 DSARs?](#who-must-comply-with-law-25-dsars)
- [The 30-Day Deadline: What You Need to Know](#the-30-day-deadline-what-you-need-to-know)
- [Step-by-Step: How to Respond to a DSAR](#step-by-step-how-to-respond-to-a-dsar)
- [What Data Must Be Included in the Report?](#what-data-must-be-included-in-the-report)
- [When Can You Refuse a Request?](#when-can-you-refuse-a-request)
- [How cookie-banner.ca Handles DSARs for You](#how-cookie-bannercanada-handles-dsars-for-you)
- [DSAR Response Checklist](#dsar-response-checklist)
...
Quebec's [Law 25](https://www.cai.gouv.qc.ca/english/) (formally the *Act respecting the protection of personal information in the private sector*) gives every Quebec resident the right to request access to all personal information an organization holds about them.
...
| Scenario | Subject to Law 25? |
|----------|-------------------|
| Business based in Quebec | Yes |
| Business outside Quebec with Quebec customers | Yes |
| Website that uses cookies and gets Quebec visitors | Yes |
| Business with no Quebec-connected data at all | No |
...
The [Commission d'acces a l'information du Quebec (CAI)](https://www.cai.gouv.qc.ca/) is the regulatory body that enforces Law 25 and investigates complaints about unresponded DSARs.
...
| Data Category | Example Data | Must Include? |
|--------------|-------------|--------------|
| Consent records | Accept/reject decisions, timestamps | Yes |
| Technical identifiers | IP addresses, user agents | Yes |
| Device information | Device type, browser, OS | Yes |
| Location data | Country, region derived from IP | Yes |
| Behavioral data | Pages visited, decision time | Yes |
| Analytics aggregates | Daily statistics, visit counts | Yes |
| Processing purposes | Why each data type is collected | Yes |
| Retention schedule | How long data is kept | Yes |
| Third-party sharing | Google Analytics, ad networks | Yes |
...
[Start handling DSARs today &rarr;](/upgrade)
...
If the requester communicates in French, best practice is to provide the report in French. Quebec's Charter of the French Language encourages French-language communications. [cookie-banner.ca's DSAR reports include bilingual labels](/upgrade) in both English and French.
