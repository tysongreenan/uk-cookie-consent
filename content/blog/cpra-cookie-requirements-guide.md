---
title: "CPRA Cookie Requirements: What Businesses Need to Know in 2026"
description: "What are CPRA cookie requirements? Complete guide to California Privacy Rights Act cookie consent, Do Not Sell or Share, sensitive data rules, and fines up to $7,500 per violation."
date: "2026-03-16"
...
schema:
  ...
  mainEntity:
    - "@type": "Question"
      name: "What are the CPRA cookie requirements?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The CPRA requires businesses to honor Do Not Sell or Share requests for cookie data, obtain opt-in consent before collecting sensitive personal information via cookies, and provide clear notice about what cookies are used and why. Businesses must display a 'Do Not Sell or Share My Personal Information' link and allow consumers to opt out of cross-context behavioral advertising cookies."
    - "@type": "Question"
      name: "What is the difference between CCPA and CPRA for cookies?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The CPRA expanded the CCPA by adding 'sharing' to the opt-out right (covering cross-context behavioral advertising), creating a new category of sensitive personal information requiring opt-in consent, establishing the California Privacy Protection Agency for enforcement, and introducing data minimization requirements that affect cookie usage."
    - "@type": "Question"
      name: "Do I need a cookie banner for CPRA compliance?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The CPRA does not require a cookie consent banner like GDPR does. However, you must provide a clearly visible 'Do Not Sell or Share My Personal Information' link on your website. If your cookies collect sensitive personal information, you also need a 'Limit the Use of My Sensitive Personal Information' link. Many businesses use a cookie banner to satisfy both requirements."
    - "@type": "Question"
      name: "What are the penalties for violating CPRA cookie requirements?"
      acceptedAnswer:
        "@type": "Answer"
        text: "CPRA fines can reach $2,500 per unintentional violation and $7,500 per intentional violation or any violation involving a minor's data. The California Privacy Protection Agency (CPPA) can enforce these penalties without giving businesses a 30-day cure period, which was available under the original CCPA."
    - "@type": "Question"
      name: "Does the CPRA apply to my business?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The CPRA applies to for-profit businesses that collect California consumers' personal information and meet at least one threshold: annual gross revenue over $25 million, buying, selling, or sharing personal information of 100,000 or more consumers or households, or deriving 50% or more of annual revenue from selling or sharing personal information."
    - "@type": "Question"
      name: "What counts as sensitive personal information under the CPRA?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Under the CPRA, sensitive personal information includes Social Security numbers, financial account details, precise geolocation, racial or ethnic origin, religious beliefs, genetic data, biometric data, health information, sex life or sexual orientation data, and the contents of private communications. Cookies that collect any of these categories require opt-in consent."
---

# CPRA Cookie Requirements: What Businesses Need to Know in 2026

<div class="direct-answer">
<strong>Direct Answer:</strong> The California Privacy Rights Act (CPRA) requires businesses to honor "Do Not Sell or Share" opt-out requests for cookie-based tracking, obtain opt-in consent before collecting sensitive personal information through cookies, and provide clear notice about cookie usage. Unlike GDPR, CPRA uses an opt-out model for most cookies — but violations carry fines of up to $7,500 per incident, enforced by the California Privacy Protection Agency (CPPA).

[Scan your cookies for free →](/tools/cookie-scanner)
</div>
...
- [What Is the CPRA and How Does It Affect Cookies?](#what-is-the-cpra-and-how-does-it-affect-cookies)
- [CCPA vs CPRA: What Changed for Cookies?](#ccpa-vs-cpra-what-changed-for-cookies)
- [How Does the CPRA Define Sensitive Personal Information?](#how-does-the-cpra-define-sensitive-personal-information)
- [How Does the CPRA Affect Cookie Consent?](#how-does-the-cpra-affect-cookie-consent)
- [Do Not Sell or Share: What Website Owners Must Know](#do-not-sell-or-share-what-website-owners-must-know)
- [CPRA Cookie Banner Requirements](#cpra-cookie-banner-requirements)
- [CPRA Enforcement and Penalties](#cpra-enforcement-and-penalties)
- [CPRA Cookie Compliance Checklist](#cpra-cookie-compliance-checklist)
...
|---------|-----------------|-----------------|
| **Opt-out scope** | "Do Not Sell" only | "Do Not Sell **or Share**" |
| **Sensitive data** | No special category | New "Sensitive Personal Information" category with opt-in consent |
| **Enforcement body** | California Attorney General | California Privacy Protection Agency (CPPA) + AG |
| **Cure period** | 30-day cure period for violations | No cure period required |
| **Data minimization** | No requirement | Must limit collection to what is "reasonably necessary" |
| **Consumer threshold** | 50,000 consumers/devices | 100,000 consumers/households (devices removed) |
| **Revenue threshold** | $25 million | $25 million (unchanged) |
| **Cookie-based sharing** | Not explicitly covered | Cross-context behavioral advertising covered |
...
For a deeper dive into the original CCPA requirements, see our [CCPA cookie compliance guide](/blog/ccpa-cpra-cookie-compliance-guide).
...
CPRA cookie consent operates differently from European regulations like the [GDPR](/blog/gdpr-cookie-consent-requirements). Here is how the consent model works:
...
> **Pro Tip**: Using a [cookie banner builder](/builder) that handles CPRA compliance automatically saves significant development time and reduces the risk of enforcement action.
...
| Violation involving a minor's data | **$7,500 per violation** |
...
> **Start your audit**: Use our [free cookie scanner](/tools/cookie-scanner) to identify every cookie on your website and check whether you are meeting CPRA cookie requirements.
...
1. Run a [free cookie scan](/tools/cookie-scanner) to identify all cookies on your site
2. Determine whether your cookies trigger "selling," "sharing," or SPI obligations
3. Implement a compliant cookie banner with a [cookie banner builder](/builder)
...
**Ready to make your website CPRA compliant?** [Build your cookie banner for free →](/auth/signup)
