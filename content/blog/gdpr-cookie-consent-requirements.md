...
schema:
  ...
  mainEntity:
    - "@type": "Question"
      name: "What is GDPR cookie consent?"
      acceptedAnswer:
        "@type": "Answer"
        text: "GDPR cookie consent is the legal requirement under the General Data Protection Regulation for websites to obtain explicit, informed permission from users before placing non-essential cookies on their devices. This includes analytics cookies, marketing cookies, and any tracking technologies that process personal data."
    - "@type": "Question"
      name: "What are the 6 GDPR cookie consent requirements?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The 6 GDPR cookie consent requirements are: (1) consent must be freely given, (2) consent must be specific to each cookie category, (3) consent must be informed with clear explanations, (4) consent must be unambiguous through affirmative action, (5) consent must be obtained before cookies are set, and (6) consent must be easy to withdraw at any time."
    - "@type": "Question"
      name: "Do I need GDPR cookie compliance if I'm not in Europe?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Yes, if you have visitors from the EU, target or monitor EU citizens, or offer goods/services to EU residents. GDPR applies based on where your users are located, not where your business operates. Any website accessible to EU residents should implement GDPR cookie compliance."
    - "@type": "Question"
      name: "What are essential cookies under GDPR?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Essential cookies (also called strictly necessary cookies) under GDPR are cookies required for a website to function properly. Examples include session management, authentication, security tokens (CSRF), load balancing, and shopping cart cookies. These do not require consent but must still be disclosed in your privacy policy."
    - "@type": "Question"
      name: "What is the penalty for GDPR cookie consent non-compliance?"
      acceptedAnswer:
        "@type": "Answer"
        text: "GDPR fines for cookie consent violations can reach up to 20 million euros or 4% of annual global revenue, whichever is greater. Notable fines include Amazon (746M in 2021), Meta (1.2B in 2023), and TikTok (345M in 2023). Even small businesses have received fines of 10,000 to 100,000 euros."
    - "@type": "Question"
      name: "Can I use Google Analytics without GDPR cookie consent?"
      acceptedAnswer:
        "@type": "Answer"
        text: "No. Google Analytics sets cookies that track user behavior and collect personal data, which requires explicit consent under GDPR. Google Analytics 4 with server-side tagging and IP anonymization may reduce the scope, but best practice is always to obtain consent before loading any analytics scripts."
    - "@type": "Question"
      name: "What's the difference between GDPR and CCPA cookie consent?"
      acceptedAnswer:
        "@type": "Answer"
        text: "GDPR (Europe) requires opt-in consent before setting cookies and applies to all EU visitors. CCPA (California) uses an opt-out model and is less restrictive. GDPR requires granular category-level consent while CCPA focuses on the right to opt out of data selling. If you comply with GDPR, you generally meet CCPA requirements too."
    - "@type": "Question"
      name: "How long can I store GDPR cookie consent?"
      acceptedAnswer:
        "@type": "Answer"
        text: "GDPR does not specify an exact consent storage duration. Industry best practice is to re-obtain consent every 12 months. The maximum recommended period is 24 months. You should also re-ask for consent whenever your cookie usage changes significantly."
    - "@type": "Question"
      name: "Do session cookies need GDPR consent?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Session cookies do not need consent if they are strictly necessary for the service the user requested, such as maintaining a login session or shopping cart. However, session cookies used for analytics, tracking, or advertising always require GDPR consent regardless of their duration."
    - "@type": "Question"
      name: "Can I use a cookie wall under GDPR?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Generally no. Cookie walls that block access to a website unless users accept all cookies violate GDPR's requirement that consent be freely given. The only exception is if you offer a genuine alternative way to access content, such as a paid subscription option."
    - "@type": "Question"
      name: "What cookies need GDPR consent?"
      acceptedAnswer:
        "@type": "Answer"
...
- [What Is GDPR Cookie Consent?](#what-is-gdpr-cookie-consent)
- [The 6 Core GDPR Cookie Consent Requirements](#the-6-core-gdpr-cookie-consent-requirements)
- [Which Cookies Require Consent Under GDPR?](#which-cookies-require-consent-under-gdpr)
- [Essential Cookies Under GDPR: What Qualifies?](#essential-cookies-under-gdpr-what-qualifies)
- [GDPR Cookie Banner Design Requirements](#gdpr-cookie-banner-design-requirements)
- [Common GDPR Cookie Compliance Mistakes](#common-gdpr-cookie-compliance-mistakes)
- [GDPR Cookie Consent Enforcement: Real Fines and Cases](#gdpr-cookie-consent-enforcement-real-fines-and-cases)
- [How to Implement GDPR-Compliant Cookie Consent](#how-to-implement-gdpr-compliant-cookie-consent)
- [GDPR Cookie Consent for Specific Platforms](#gdpr-cookie-consent-for-specific-platforms)
- [GDPR vs Other Cookie Consent Laws](#gdpr-vs-other-cookie-consent-laws)
- [GDPR Cookie Compliance Checklist](#gdpr-cookie-compliance-checklist)
...
|----------|----------|-------------------|
| **Strictly Necessary** | Authentication, security, shopping cart | No |
...
Use our [free cookie scanner](/tools/cookie-scanner) to automatically detect cookies that load before consent.
...
### Analytics Cookies -- Consent Always Required
...
### Marketing and Advertising Cookies -- Consent Always Required
...
### Functional Cookies -- Consent Technically Required
...
### The Legal Test for Essential Cookies
...
Organizations in regulated industries like [healthcare](/solutions/healthcare) should be particularly careful with essential cookie classifications, as health data processing carries additional requirements under GDPR Article 9.
...
### Mistake 3: Pre-Ticked Consent Boxes
...
### Mistake 4: Cookie Walls Without Alternatives
...
### Mistake 5: Bundling All Consent Together
...
### Mistake 7: Not Keeping Consent Records
...
## GDPR Cookie Consent Enforcement: Real Fines and Cases
...
### Major GDPR Cookie Consent Fines

| Company | Fine | Year | Violation |
|---------|------|------|-----------|
| Amazon | 746M euros | 2021 | Targeted advertising without valid consent |
| Meta (Facebook) | 1.2B euros | 2023 | Data transfers and consent failures |
| TikTok | 345M euros | 2023 | Children's privacy and cookie consent |
| Google (France) | 150M euros | 2022 | Cookie rejection not as easy as acceptance |
| Microsoft (France) | 60M euros | 2022 | Cookies deposited without consent |
| Sephora (Italy) | 20K euros | 2023 | Cookie banner non-compliance |
| Various SMBs | 5K-100K euros | 2022-2025 | Cookie consent violations |
...
**Automated audit:** Use our [cookie scanner tool](/tools/cookie-scanner) to automatically detect and categorize all cookies on your website. This catches cookies you might miss in a manual audit, including those set by third-party scripts.

### Step 2: Choose a Cookie Consent Solution

**Option 1: Purpose-Built Cookie Consent Platform (Recommended)**

A dedicated platform like [Cookie Banner](https://www.cookie-banner.ca) handles the legal and technical complexity for you:
...
- [React integration](/integrations/react) for modern web apps

Looking for alternatives to existing tools? See how we [compare to Cookiebot](/compare/cookiebot-alternative).
...
Configure Google Tag Manager to use consent mode, firing tags only when the appropriate consent category has been granted.

**Server-side approach:**
For applications using frameworks like Next.js, you can conditionally render tracking scripts based on cookie consent state, preventing them from ever reaching the client's browser without consent.
...
## GDPR Cookie Consent for Specific Platforms
...
We provide a dedicated [React integration](/integrations/react) that handles:
...
See our [healthcare solutions page](/solutions/healthcare) for industry-specific guidance on cookie consent in medical and health-related contexts.

---

## GDPR vs Other Cookie Consent Laws
...
|--------|------|-----------|
| Consent model | Opt-in (prior consent) | Opt-out |
| Scope | EU/EEA residents | California residents |
| Cookie consent required | Yes, explicit | Not specifically for cookies |
| Right to delete | Yes | Yes |
| Fines | Up to 20M euros or 4% revenue | Up to $7,500 per violation |
...
### What are the 6 GDPR cookie consent requirements?
...
### Do I need GDPR cookie compliance if I'm not in Europe?
...
### What's the difference between GDPR and CCPA cookie consent?
...
### Can I use Google Analytics without GDPR cookie consent?
...
### How long can I store GDPR cookie consent?
...
### Do session cookies need GDPR consent?
...
### What's the penalty for GDPR cookie consent non-compliance?
...
### Can I use a cookie wall under GDPR?
